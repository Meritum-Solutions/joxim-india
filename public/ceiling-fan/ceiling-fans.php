					...
					<div class="row pro-wel-row">
						...
						<div class="col-md-6 pro-wel-col">
							<div class="pro-wel-img pro-wrap txtct">
								<img src="<?php echo $path; ?>img/fan-white.png" alt="" class="img-fluid">
							</div>
						</div>
						<div class="col-md-6 pro-wel-col">
						...
						<div class="col-md-6 pro-wel-col">
							<div class="pro-wel-rt pro-wrap">
								...
								<p>
									Lorem ipsum dolor, sit amet consec tetur, adipis icing elit. Molest iae dolo ribus eaque ipsa eum hic ratione omnis, eveniet, repudi.
								</p>
								<div class="pro-btn">
									<a href="" class="btn hm-wel-btn-o">Konw More</a>
								</div>
						...
						<div class="col-md-6 pro-wel-col">
							<div class="pro-wel-img pro-wrap txtct">
								<img src="<?php echo $path; ?>img/fan-black.png" alt="" class="img-fluid">
							</div>
						</div>

						<div class="col-md-6 pro-wel-col">
							<div class="pro-wel-img pro-wrap txtct">
								<img src="<?php echo $path; ?>img/fan-brown.png" alt="" class="img-fluid">
							</div>
						</div>
						<div class="col-md-6 pro-wel-col">
							<div class="pro-wel-rt pro-wrap">
								...
								<p>
									Lorem ipsum dolor, sit amet conse ctetur, adipis icing elit. Molestiae dolo ribus eaque ipsa eum hic ratione omnis, eveniet, repudiandae.
								</p>
								<div class="pro-btn">
									<a href="" class="btn hm-wel-btn-o">Konw More</a>
								</div>
