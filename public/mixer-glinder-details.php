...
// $id = $_GET['id'];
    ...
    $query = "SELECT * FROM `products` WHERE category='mixer glinder' and id= $id  ";
								...
								<table class="table joxim-table">
								  <tbody>
								    ...
								    <tr>
								     ...
								     <tr>
								      <th>Protection</th>
								      <td><?php echo $row['protection']; ?></td>
								    </tr>
								     <tr>
								      <th>Blade</th>
								      <td><?php echo $row['blade']; ?></td>
								    </tr>
								  </tbody>
								 </table> 
							</div>
							...
							<div class="row">
								...
								<div class="col-md-6 salient-sp-btm">
									...
									<div class="stabilizer-details-wrap-side">
										...
										<ul>
											<li>
												<i class="fa-solid fa-circle-arrow-right"></i>Copper Armature
											</li>
											<li>
												<i class="fa-solid fa-circle-arrow-right"></i>Cool Touch ABS Heavy Body
											</li>
											<li>
												<i class="fa-solid fa-circle-arrow-right"></i>Speed Control Nobs
											</li>
											<li>
												<i class="fa-solid fa-circle-arrow-right"></i>Low Noice Operation
											</li>
										</ul>
									</div>
								</div>
