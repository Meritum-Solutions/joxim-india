					...
					<div class="row align-c details-row">
						...
						<div class="col-md-12 stabilizer-col">
							<div class="stabilizer-details-wrap">
								<p>
									Turn the safety up and turn the maintenance down. Because your air contion are precious and we understand your needs.
								</p>
						...
						<div class="col-md-6 salient-sp-btm">
							...
							<div class="stabilizer-details-wrap-side">
								...
								<ul>
									...
									<li>
										<i class="fa-solid fa-circle-arrow-right"></i>Table Top
									</li>
									<li>
										<i class="fa-solid fa-circle-arrow-right"></i>Digital Display
									</li>
								</ul>
							</div>
						</div>
